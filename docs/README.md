...
- [Voice: Wyoming → Assist → GoodVibes](voice-assist.md): using the conversation entity as the agent in an Assist pipeline fed by a Wyoming satellite, and what stays with Home Assistant and Wyoming.
...
- [Known limits](known-limits.md): current operational limits around upload size, stale daemon clients, Home Graph ownership, release delivery, and reset and import boundaries.
