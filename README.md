...
Custom Home Assistant integration for the GoodVibes daemon Home Assistant surface from `@pellux/goodvibes-sdk` `0.34.0`.
...
1. Run a GoodVibes daemon with `@pellux/goodvibes-sdk@0.34.0` or newer.
...
- GoodVibes daemon using `@pellux/goodvibes-sdk@0.34.0` or newer.
