...
Custom Home Assistant integration for the GoodVibes daemon Home Assistant surface from `@pellux/goodvibes-sdk` `0.26.11`.
...
- GoodVibes daemon using `@pellux/goodvibes-sdk@0.26.11` or newer.
...
The integration supports the SDK `0.26.11` Home Graph daemon routes:
