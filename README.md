...
| Sensors, repairs, update | Diagnostic sensors for daemon status, last reply, active session/message/agent IDs, tool catalog, Home Graph status/issues/sources and mail/calendar status; repairs for Home Graph availability and unresolved issues; a GitHub-release-backed update entity | — |
