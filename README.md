...
Custom Home Assistant integration for the GoodVibes daemon Home Assistant surface from `@pellux/goodvibes-sdk` `0.26.8`.
...
- GoodVibes daemon using `@pellux/goodvibes-sdk@0.26.8` or newer.
...
The integration supports the SDK `0.26.8` Home Graph daemon routes:
