...
Custom Home Assistant integration for the GoodVibes daemon Home Assistant surface from `@pellux/goodvibes-sdk` `0.28.0`.
...
- GoodVibes daemon using `@pellux/goodvibes-sdk@0.28.0` or newer.
...
The integration supports the SDK `0.28.0` Home Graph daemon routes:
