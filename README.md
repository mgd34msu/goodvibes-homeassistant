...
Custom Home Assistant integration for the GoodVibes daemon Home Assistant surface from `@pellux/goodvibes-sdk` `0.33.38`.
...
1. Run a GoodVibes daemon with `@pellux/goodvibes-sdk@0.33.38` or newer.
...
- GoodVibes daemon using `@pellux/goodvibes-sdk@0.33.38` or newer.
