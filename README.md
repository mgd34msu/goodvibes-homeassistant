...
Custom Home Assistant integration for the GoodVibes daemon Home Assistant surface from `@pellux/goodvibes-sdk` `0.27.9`.
...
- GoodVibes daemon using `@pellux/goodvibes-sdk@0.27.9` or newer.
...
The integration supports the SDK `0.27.9` Home Graph daemon routes:
