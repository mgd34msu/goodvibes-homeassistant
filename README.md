...
Custom Home Assistant integration for the GoodVibes daemon Home Assistant surface from `@pellux/goodvibes-sdk` `0.27.4`.
...
- GoodVibes daemon using `@pellux/goodvibes-sdk@0.27.4` or newer.
...
The integration supports the SDK `0.27.4` Home Graph daemon routes:
